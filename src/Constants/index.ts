...
export const DEFAULT_FACTORY_ADDRESS = '0x65899Dc47C2a9C91a06b055C58426d51cC0543BB' 
export const ROUTER_ADDRESS = '0x0Ee37BeDf7FE3873DA77b0CF6Bc17dD8E76c6be7'

// QUICKSWAP Factory + Router (mumbai)
//export const DEFAULT_FACTORY_ADDRESS = '0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32',
//export const ROUTER_ADDRESS = '0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff',
export const DEFAULT_INIT_CODE_HASH = "0xaae7dc513491fb17b541bd4a9953285ddf2bb20a773374baecc88c4ebada0767"
...
export const DEFAULT_POOLS = [
  new Pool(0, "MATIC - GHST", DEFAULT_TOKENS[0], DEFAULT_TOKENS[1],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH,  {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[1]}),
  new Pool(1, "GHST - DAI", DEFAULT_TOKENS[1], DEFAULT_TOKENS[2],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH,  {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[2]}),
  new Pool(2, "GHST - WETH", DEFAULT_TOKENS[1], DEFAULT_TOKENS[3],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[3]}),
  new Pool(3, "GHST - FUD", DEFAULT_TOKENS[1], DEFAULT_TOKENS[4],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[4]}),
  new Pool(4, "GHST - FOMO", DEFAULT_TOKENS[1], DEFAULT_TOKENS[5],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[5]}),
  new Pool(5, "GHST - ALPHA", DEFAULT_TOKENS[1], DEFAULT_TOKENS[6],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[6]}),
  new Pool(6, "GHST - KEK", DEFAULT_TOKENS[1], DEFAULT_TOKENS[7],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[7]}),
  new Pool(7, "GHST - AAVE", DEFAULT_TOKENS[1], DEFAULT_TOKENS[8],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[8]}),
  new Pool(8, "GHST - UNI", DEFAULT_TOKENS[1], DEFAULT_TOKENS[9],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[9]}),
  new Pool(9, "GHST - USDC", DEFAULT_TOKENS[1], DEFAULT_TOKENS[10],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[10]}),
  new Pool(10, "GHST - USDT", DEFAULT_TOKENS[1], DEFAULT_TOKENS[11],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[11]}),
  new Pool(11, "GHST - WBTC", DEFAULT_TOKENS[1], DEFAULT_TOKENS[12],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[12]}),
  new Pool(12, "GHST - LINK", DEFAULT_TOKENS[1], DEFAULT_TOKENS[13],  DEFAULT_FACTORY_ADDRESS, DEFAULT_INIT_CODE_HASH, {tokenA: DEFAULT_LOGOS[1], tokenB: DEFAULT_LOGOS[13]}),
]
