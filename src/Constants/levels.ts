...
export const levels: LevelCard[] = [
    {
        ...
        title: "Landing",
        learn: null,
        ressources: "https://beincrypto.com/learn/web3-wallet/",
    ...
    },
    {
        id: '2',
        title: "Approve",
        learn: " As the tokens comes from a smart contract written in a virtual ledger securised by the blockchain the owner of a token need to “approve” an operator with a certain ammount in order to let him transfert your token to another address.",
        ressources: "https://github.com/ethereumbook/ethereumbook/blob/develop/04keys-addresses.asciidoc#private-keys",
    ...
    },
    {
        ...
        learn: null,
        ressources: "One major key concept in the blockchain is that it is  100% transparent, yes ser you heard it you can see every single transactions that happenned since its creation ! Each blockchains/networks has its own “Ledger” and with it a “Block explorer” to naviguate through and find pertinent informations to the state of the ledger, you can find the Mumbai one here -> https://mumbai.polygonscan.com/",
    ...
    },
    {
        id: '7',
        title: "Market maker",
        learn: "We know it, DeFi everything is permissionless, that's also mean that anyone can become a market maker allowing other people swapping one token for another including a small fee for the persons who added liquidity for it.",
    ...
    },
    {
        ...
        learn: "What make the price of an asset ? Well by comparing with a another one ! :D",
        ressources: "Be careful some token can have the same name or same symbol but that does not mean they are the same ! The only true and unique identifier is his address.",
    ...
    },
    {
        ...
        learn: "Liquidity is key in an AMM ! The more liquidity there is inside the less the price impact will be when exchanging large amount of token against another ",
        ressources: null,
