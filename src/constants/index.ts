import { JSBI, Percent, Token, ChainId } from 'quickswap-sdk';
...
export const GlobalValue = {
  ...
  tokens: {
    MATIC: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
    MATIC1: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
    MATIC2: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
    MATIC3: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
    MATIC4: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
    MATIC5: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
    MATIC6: new Token(ChainId.MUMBAI, '0x0000000000000000000000000000000000000000', 18, 'WMATIC', 'GW3S  Wrapped Matic'),
  },
};
