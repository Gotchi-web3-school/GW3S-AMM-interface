...
export const DEFAULT_POOLS = [
  new Pool(0, "GHST - DAI", DEFAULT_TOKENS[0], DEFAULT_TOKENS[1], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[1]}),
  new Pool(1, "GHST - WETH", DEFAULT_TOKENS[0], DEFAULT_TOKENS[2], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[2]}),
  new Pool(2, "GHST - FUD", DEFAULT_TOKENS[0], DEFAULT_TOKENS[3], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[3]}),
  new Pool(3, "GHST - FOMO", DEFAULT_TOKENS[0], DEFAULT_TOKENS[4], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[4]}),
  new Pool(4, "GHST - ALPHA", DEFAULT_TOKENS[0], DEFAULT_TOKENS[5], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[5]}),
  new Pool(5, "GHST - KEK", DEFAULT_TOKENS[0], DEFAULT_TOKENS[6], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[6]}),
  new Pool(6, "GHST - AAVE", DEFAULT_TOKENS[0], DEFAULT_TOKENS[7], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[7]}),
  new Pool(7, "GHST - UNI", DEFAULT_TOKENS[0], DEFAULT_TOKENS[8], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[8]}),
  new Pool(8, "GHST - USDC", DEFAULT_TOKENS[0], DEFAULT_TOKENS[9], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[9]}),
  new Pool(9, "GHST - USDT", DEFAULT_TOKENS[0], DEFAULT_TOKENS[10], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[10]}),
  new Pool(10, "GHST - WMATIC", DEFAULT_TOKENS[0], DEFAULT_TOKENS[11], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[11]}),
  new Pool(11, "GHST - WBTC", DEFAULT_TOKENS[0], DEFAULT_TOKENS[12], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[12]}),
  new Pool(12, "GHST - LINK", DEFAULT_TOKENS[0], DEFAULT_TOKENS[13], {tokenA: DEFAULT_LOGOS[0], tokenB: DEFAULT_LOGOS[13]}),
]
